...
namespace Library.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(ApplicationDpContext context)
        {
            _context = context;
        }
        ...
        {
            var applicationDpContext = _context.Orders.Include(o => o.User);
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var order = await _context.Orders
                .Include(o => o.User)
                .FirstOrDefaultAsync(m => m.OrderISBN == id);
            if (order == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("OrderISBN,NameBook,Quantity,Date,Price,Status,UserId")] Order order)
        {
        ...
        public async Task<IActionResult> Edit(string id, [Bind("OrderISBN,NameBook,Quantity,Date,Price,Status,UserId")] Order order)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!OrderExists(order.OrderISBN))
                    {
                        return NotFound();
                    }
                    else
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDpContext.Orders'  is null.");
            }
            var order = await _context.Orders.FindAsync(id);
            if (order != null)
            {
